        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
				new NavMenuItem()
				{
					...
					Label = "Part1: Solve 3SAT using Genetic Algorithms",
					DestinationPage = typeof(Views.Part1_GeneticAlgorithm),
				},
				new NavMenuItem()
				{
					Symbol = Symbol.Folder,
					Label = "Part2: MinMax Problem",
					DestinationPage = typeof(Views.Part1_GeneticAlgorithm),
				},
				new NavMenuItem()
				{
					Symbol = Symbol.Folder,
					Label = "Part3: Constraint Satisfaction Sudoku",
					DestinationPage = typeof(Views.Part1_GeneticAlgorithm),
				},
				new NavMenuItem()
				{
					Symbol = Symbol.Folder,
					Label = "Part5: Travelling Salesman",
					DestinationPage = typeof(Views.Part1_GeneticAlgorithm),
				},
            });
